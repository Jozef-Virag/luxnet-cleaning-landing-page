...
const heading = "Prečo využívať naše upratovacie služby";
const subHeading = "Profesionálne čistenie pre vaše pohodlie a spokojnosť.";
const buttonLearnMore = "Viac informácií";
const advantages = [
  {
    name: "Efektívne upratovanie",
    des: "Naše upratovacie služby sú rýchle a efektívne, takže sa môžete sústrediť na to, čo je pre vás dôležité.",
  },
  {
    name: "Profesionálny prístup",
    des: "Náš tím profesionálov zabezpečí, že vaše priestory budú vždy dokonale vyčistené a pripravené na použitie.",
  },
  {
    name: "Kvalitné čistiace prostriedky",
    des: "Používame len najkvalitnejšie a ekologické čistiace prostriedky, ktoré sú bezpečné pre vašu rodinu aj domácich miláčikov.",
  },
  {
    name: "Flexibilné služby",
    des: "Ponúkame flexibilné plány upratovania, aby sme vyhoveli vašim potrebám a rozvrhu.",
  },
];
</script>
...
<template>
  <div class="untree_co-section">
    <div class="container">
      <div class="row mb-4">
        <div class="col-12 text-center mb-4" data-aos="fade-up" data-aos-delay="0">
